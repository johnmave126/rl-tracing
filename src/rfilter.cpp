...
TRACER_REGISTER_CLASS(GaussianFilter, "gaussian");
TRACER_REGISTER_CLASS(MitchellNetravaliFilter, "mitchell");
TRACER_REGISTER_CLASS(TentFilter, "tent");
TRACER_REGISTER_CLASS(BoxFilter, "box");
